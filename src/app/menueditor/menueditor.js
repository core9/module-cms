...
.run(function(MenuService, MenuEntryTypes) {
  MenuEntryTypes
  .registerMenuEntryType({id: 'nav', name: 'Menu', templateUrl: 'menueditor/entrytypes/nav.tpl.html', configUrl: 'menueditor/entrytypes/ul.config.tpl.html', childs: ['navitem', 'li']})
  .registerMenuEntryType({id: 'navitem', name: 'Top level entry', templateUrl: 'menueditor/entrytypes/navitem.tpl.html', configUrl: 'menueditor/entrytypes/li.config.tpl.html', childs: ['ul', 'text']})
